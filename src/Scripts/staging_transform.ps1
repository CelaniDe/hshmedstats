...
$ConnectionString = 'Server=pcsinvoicing.database.windows.net; Database=pcsinvoicingdb; User Id=pcsadmin; password=123*789adminPcs#$59147'
$JsReportUrl = "https://pcsjsreporting.azurewebsites.net"
$JsReportUser = "pcsreportadmin"
$JsReportPassword = "pcsreportadminpA55w0rd"
...
$blobStorageEuContainer = "pcseu"
$blobStorageUkContainer = "pcsuk"
